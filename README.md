...
## 1. Introducción
En su obra *El software toma el mando*, Lev Manovich nos explica que el software no es solo una herramienta, sino la capa invisible que dirige nuestra cultura. Si Manovich tuviera que actualizar sus tesis hoy, se encontraría con un escenario donde la hibridación ha dado un salto gigante: ya no solo mezclamos fotos y texto en una web, sino que mezclamos nuestro esfuerzo físico real con mundos virtuales, o nuestra imaginación verbal con algoritmos de creación visual. En este ensayo analizo dos casos que son puro ADN de la hibridación moderna: **Zwift** y **Midjourney**.
...
* **Uso de IA:** Se ha utilizado la asistencia de la IA Gemini (Google) para la estructuración de ideas y supervisión de la redacción, bajo la supervisión y validación directa del autor.
